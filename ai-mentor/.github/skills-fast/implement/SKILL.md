...
### Implement
1. Read `PROJECT_CONTEXT.md`. Read relevant existing files to match patterns.
2. Use Sequential Thinking to identify the approach. If multiple viable approaches surface, present the top 2 with concrete tradeoffs and let the user choose.
