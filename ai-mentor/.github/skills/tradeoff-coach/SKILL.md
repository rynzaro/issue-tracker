...
Always present at least 2 alternatives. Use specifics from the project (reference `PROJECT_CONTEXT.md` and documented decisions), not abstractions.
...
- **"It's the standard way"** → "Standard in what context? Does this project's specific constraints change the calculus?"
...
- How this connects to existing decisions in the project (contextualize)
