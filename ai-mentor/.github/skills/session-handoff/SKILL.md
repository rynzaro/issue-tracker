...
Produce a structured handoff that lets a new session resume without re-reading the entire codebase. Format matches the proven structure used in `.chat/session-handoff-*.md` files.
